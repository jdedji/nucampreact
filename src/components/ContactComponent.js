...
class Contact extends Component{
        ...
        constructor(props) {
            ...
            // this.handleInputChange = this.handleInputChange.bind(this); /This is replace by redux
    ...
    render(){
       // const errors = this.validate(this.state.firstName, this.state.lastName, this.state.phoneNum, this.state.email); // error oject set because the first error object isnt global  
    return (
            ...
            <div className="row row-content">
                   <div className="col-12">
                    ...
                    <div className="col-md-10">
                       {/* <Form onSubmit={this.handleSubmit}> replace for redux
                        <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="firstName" name="firstName"
                                        ...
                                        invalid={errors.firstName}//this is invalid attribut set for errors filed
